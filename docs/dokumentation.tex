...
Python unterstützt standardmässig Unittests. Diese werden verwendet, um die einzelnen Komponenten des Algorithmus zu testen.

Bei Änderungen am Quellcode werden die Unittests verwendet, um zu prüfen, ob Seiteneffekte auftreten und ob es zu Fehlern kommt.
\newpage
