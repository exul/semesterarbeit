...
Bei der Instanz ts225 sind die Knoten auf den Seiten eines Quadrates platziert. Dieses Quadrat ist wiederum durch 4 x 4 Quadrate unterteilt, auf deren Ränder sich die Knoten befinden.
        ...
        \begin{table}[H]
                ...
                \label{tab:ts225}
        \end{table}
Die Abweichung beider Algorithmen ist relativ gering, da der minimale Spannbaum nahe an der optimalen Lösung liegt. Da weder der Hamiltonpfad noch der Hamiltonkreis gross von diesen Quadraten abweichen, ist keiner der beiden Algorithmen im Vorteil.
