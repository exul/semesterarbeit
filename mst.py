...
neighbour_edges = my_graph.neighbour_edges(start_node)
...
while mst.size < graph_size:
    ...
    my_graph.remove_edge(next_edge)
    ...
    if not(mst.contains_node(next_edge.node_1) and \
        ...
        if mst.contains_node(next_edge.node_1):
            neighbour_edges = neighbour_edges + my_graph.neighbour_edges(next_edge.node_2)

            mst.add_node(next_edge.node_2)
        else:
            neighbour_edges = neighbour_edges + my_graph.neighbour_edges(next_edge.node_1)
